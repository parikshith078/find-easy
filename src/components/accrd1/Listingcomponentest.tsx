...
function Rentprop(props) {
  ...
  return (
    ...
    <h2 className="flex bg-base-100 mt-4"> <BiCurrentLocation className="mt-1 mr-2"/>Property Address : </h2>
    <input type="text"  
    ...
    {/* //pincode of propety  */}
    <h2 className="flex mt-8"><TbLocationFilled className="mt-1 mr-2"/>Pincode : </h2>
    <input type="number" 
    ...
    {/* //price of propety */}
    <h2 className="flex bg-base-100 mt-8"> <BiCurrentLocation className="mt-1 mr-2"/>Price : </h2>
    <input type="number"  
    ...
    {/* //property view  */}
    <h2 className=" flex mt-8 bg-base-100"> <BsCameraFill  className=" mt-1 mr-2"/>Front view of Property : </h2>
    <div className="flex bg-base-100"> 
           ...
           <input type="file" 
           accept=".jpg"
            value={rentprop.photo} 
            className="ml-4 mt-[65px] bg-base-100"
            name='photo'
            onChange={handelchange}
            />
    </div>
    <div><button onClick={submitrentprop} className='ml-[500px] font-extrabold mt-10'>SUBMIT</button></div>
    </div>
  </div>
  );
};
