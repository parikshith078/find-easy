            ...
            <div className="pb-20">
              <div className="text-center lg:text-left grid gap-y-0 grid-row-3 pl-10 pr-20">
                ...
                <p className="py-6">
                  ...
                  available for sale. Grab this 3 BHK property for sale in one
                  of Bengaluru top location, Attibele. The property price of
                  this unit is Rs 1.4 Cr. Monthly maintenance costs Rs 2000. The
